export const metadata = { title: "Duyurular — DAMI BEAUTY" };

export default function NoticePage() {
  return (
    <section className="mx-auto max-w-3xl px-5 py-20">
      <p className="section-label mb-3">COMMUNITY</p>
      <h1 className="text-lg font-semibold uppercase tracking-wide text-dami-900 dark:text-dami-100">DUYURULAR</h1>
      <p className="mt-4 text-sm text-dami-500">Duyuru sayfası hazırlanıyor.</p>
      <div className="mt-10 divide-y divide-dami-100 border-t border-dami-200 dark:divide-dami-800 dark:border-dami-800">
        {["Hizmete Açılış", "Kargo Politikası", "İade & Değişim"].map((title, i) => (
